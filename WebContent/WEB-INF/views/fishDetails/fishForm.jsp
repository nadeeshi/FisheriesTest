        ...
        <section class="content">
          <div class="row">
              ...
              <div class="box">
                ...
                <div class="container">
                	<h2  style="margin-left:200px;"><b>Fish Tour Records</b></h2>
                <br><br>
               		<div class="col-md-5 col-sm-6 col-xs-12">
              			<div class="info-box">
                			<span class="info-box-icon bg-aqua"><i class="ion ion-ios-gear-outline"></i></span>
                			<div class="info-box-content">
                 			 	<span class="info-box-text"><h3><a href="fishDetailss.html"><b>List of Tour Details</b></a></h3></span>
              		...
              		<div class="col-md-6 col-sm-6 col-xs-12">
              			<div class="info-box">
                			 ...
                			 <div class="info-box-content">
                  				<span class="info-box-text"><h3><a href="add.html"><b>Add New Tour Record</b></a></h3></span>
