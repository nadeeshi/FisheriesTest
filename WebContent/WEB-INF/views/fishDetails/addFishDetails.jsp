	...
	<div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<form:form method="POST" action="/FisheriesTest/save.html">
	   		<table>
			    <tr>
			        <td><form:label path="id">FishDetails ID:</form:label></td>
			        <td><form:input path="id" value="${fishDetails.id}" readonly="true"/></td>
			    </tr>
			    <tr>
			        <td><form:label path="name_of_skipper">name_of_skipper:</form:label></td>
			        <td><form:input path="name_of_skipper" value="${fishDetails.name_of_skipper}"/></td>
			    </tr>
			    <tr>
			        <td><form:label path="skipper_license_number">skipper_license_number:</form:label></td>
			        <td><form:input path="skipper_license_number" value="${fishDetails.skipper_license_number}"/></td>
			    </tr>
