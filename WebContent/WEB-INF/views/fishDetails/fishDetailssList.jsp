        ...
        <section class="content">
          <div class="row">
              ...
              <div class="box">
                ...
                <div class="container">
                	<h2  style="margin-left:200px;"><b>List Of Fish Tour Records</b></h2>
                <br><br>
               		<div class="col-md-5 col-sm-6 col-xs-12">
              			 
<h3><a href="add.html">Add More Tour Record</a></h3>

<c:if test="${!empty  fishDetailss}">
		 
	<table align="left" border="1">
		<tr>
			<th>FishDetails ID</th>
			<th>name_of_skipper</th>
			<th>skipper_license_number</th>
			 
			<th>Actions on Row</th>
		</tr>

		<c:forEach items="${fishDetailss}" var="fishDetails">
			<tr>
				<td><c:out value="${fishDetails.id}"/></td>
				<td><c:out value="${fishDetails.name_of_skipper}"/></td>
				<td><c:out value="${fishDetails.skipper_license_number}"/></td>
				 
				<td align="center"><a href="edit.html?id=${fishDetails.id}">Edit</a> | <a href="delete.html?id=${fishDetails.id}">Delete</a></td>
			</tr>
		</c:forEach>
	</table>
</c:if>
